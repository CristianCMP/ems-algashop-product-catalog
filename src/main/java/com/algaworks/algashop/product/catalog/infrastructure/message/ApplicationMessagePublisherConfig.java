...
public class ApplicationMessagePublisherConfig {
    ...
    @Bean
    public ApplicationMessagePublisher applicationMessagePublisher(ApplicationEventPublisher applicationMessagePublisher) {
        return applicationMessagePublisher::publishEvent;
    }
}
